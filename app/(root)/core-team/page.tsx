...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image: '/assets/Pratim_kundu_FA.png',
      instagram: "culturals.iitmandi",
  ...
  const culturalSecretaryAndAdvisor = teamMembers.filter(
    (member) => member.role === "Cultural Secretary" || member.role === "Faculty Advisor"
  );
    ...
    <section className="py-8">
      ...
      <div className="flex flex-wrap justify-center mb-20">
        {culturalSecretaryAndAdvisor.map((member, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8 flex justify-center">
